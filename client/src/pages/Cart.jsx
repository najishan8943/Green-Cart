...
const Cart = () => {
    ...
    const {products, currency, cartItems, removeFromCart, getCartCount, updateCartItem, setCartItems,navigate, getCartAmount, axios, user} = useAppContext()
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                               { addresses.map((address, index)=>(
                                 <p onClick={() => {setSelectAddresses(address);setShowAddress(false)}}
