    ...
    return product && (
        <div className="mt-12">
            <p>
                ...
                {/* <Link to={`/products/${product.category}/${product._id}`}>{product.category}</Link> / */}
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        <button onClick={()=>addToCart(product._id)} className="w-full py-3.5 cursor-pointer font-medium bg-gray-100 text-gray-800/80 hover:bg-primary transition" >
                            Add to Cart
                        </button>
            ...
            <div className="flex flex-col items-center w-max">
                <p className=" mt-12 text-3xl font-medium">Related Products</p>
            ...
            rounded text-primary hover:bg-primary/10 transition">Show More</button>
            </div>
        </div>
    );
};
