            ...
            rounded-lg shadow-xl border-gray-200'>
             ...
             Login</p>
                 <div className='w-full'>
                  ...
                  <div className='w-full'>
                    <p>Password</p>
                    <input required onChange={(e)=> setPassword(e.target.value)} value={password} type="password" placeholder='Enter your password' className='border border-gray-200 rounded w-full p-2 mt-1 outline-primary' />
                 </div>
